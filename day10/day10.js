...
let instructions = fs.readFileSync('../day10/day10.txt').toString().split('')
...
console.log('Day 10 Part 1: ', hash[0] * hash[1])


    //pt 2
    let inputString = fs.readFileSync('../day10/day10.txt').toString()
    ...
    console.log('Day 10 Part 2: ', generateKnotHash(generateDenseHash(createSparseHashFromASCII(list, createLengthsASCIIString(inputString)))))
